...
source("modules/scz_risk.R")            # 精神分裂症患病风险辅助诊断（容器）
source("modules/scz_adolescent.R")      # 青少年精神分裂症风险预测
source("modules/scz_adult_risk.R")      # 成人精神分裂症风险预测
source("modules/scz_treatment.R")       # 成人精神分裂症疗效预测
    ...
    sidebarMenu(
      ...
      menuItem(
        ...
        menuSubItem(
          "患病风险辅助诊断",
          icon = icon("diagnoses"),
          tabName = "scz_risk"              # ✅ 容器页面，包含青少年和成人
        ),
